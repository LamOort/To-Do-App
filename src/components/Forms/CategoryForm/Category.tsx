...
const CategoryForm = () => {
  ...
  const [colorDisplay, setColorDisplay] = useState(capturedCategoryObj.color);

  const [nameDisplay, setNameDisplay] = useState(capturedCategoryObj.name);
  ...
  return (
    <form className="CategoryForm">
      ...
      <svg
        ...
        onClick={() => dispatch(setModalType('DeleteCategory'))}
      >
        <path
          id="trash-solid-2"
